...
class Fuel:
  ...
  def __init__(self) : 	
    ...
    self.particleDensity = None
    self.sigma = None
    self.extMoisture = None
    self.fuelMoisture = None
    self.calcExponentA = RothermelExponentA
    self.calcNetFuelLoading = RothermelNetFuelLoading
    self.setMineralContent(0.0555, 0.01)
    self.setHeatContent(8000.0)
  def setDensity(self, bulk, particle) : 
    """
  ...
  def setSigma(self, sigma) : 
    ...
    self.calcExponentA(self)
    self.heatingEfficiency = math.exp(-138/sigma)
  def setFuelMoisture(self, fuel, extinction) :
    """
...
class RothermelModel : 
  ...
  def evaluate(self) : 
    ...
    """
    self.fuel.calcNetFuelLoading(self.fuel)
